...
namespace Spark {
	...
	class SPARK_API WindowResizedEvent : public Event
	{
	public:
	...
	class SPARK_API WindowClosedEvent : public Event
	{
	public:
		WindowClosedEvent() {}
	...
	class SPARK_API AppTick : public Event
	{
	public:
		AppTick();
	...
	class SPARK_API AppUpdate : public Event
	{
	public:
		AppUpdate();
	...
	class SPARK_API AppRender : public Event
	{
	public:
		AppRender();
